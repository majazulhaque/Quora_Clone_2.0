...
function Post() {
  return (
    <div className='post'>
        ...
        <div style={{margin:"5px 0px 0px 0px",padding:"5px 0px 0px 0px",borderTop:"1px solid lightgray"}} className="post__answer">
            <div style={{display:"flex",flexDirection:"column",width:"100%",padding:"100px 5px",borderTop:"1px solid lightgray"}} className="post-answer-container">
